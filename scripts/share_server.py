...
__author__ = "bitzend"
__edited_by___ = "DebuggerX"
__home_page__ = "www.debuggerx.com"
...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if 'use-clipper' in self.headers:
            ...
            if data == b'get':
                ...
                if clipper_set(urllib.parse.unquote(data.decode(encoding="utf-8"))):
                    res = 'success'
                else:
                    res = 'error'
    ...
    def list_directory(self, path):
        ...
        f.write(b"<body>\n")
        f.write(javascript)
        f.write(b"<div style=\"float:left;margin-right:20px\"><form ENCTYPE=\"multipart/form-data\" method=\"post\">")
        f.write(b"<input name=\"file\" type=\"file\"/>")
        f.write(b"<input type=\"submit\" value=\"upload\"/></form></div>\n")
        f.write(b"<div style=\"float:left\">")
        f.write(b"<div style=\"float:left;margin-right:20px\"><textarea <input style=\"width:230px;height:50px\" id=\"ta\"></textarea></div>\n")
        f.write(b"<div style=\"float:left\">")
        f.write(b"<div style=\"margin:5px 10px 1px;\"><input style=\"width:50px;\" type=\"button\" onclick=do_ajax(true) value=\"get\"/></div>")
        f.write(b"<div style=\"margin:1px 10px 5px\"><input style=\"width:50px;\" type=\"button\" onclick=do_ajax(false) value=\"send\"/></div>")
        f.write(b"</div>\n</div>\n</div>\n")
